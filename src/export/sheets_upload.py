...
upload_csv_to_sheet("./docs/data/leaderboard.csv", "Leaderboard")
print(f"{GREEN}Haupt-Rangliste hochgeladen.{RESET}")
print(f"{BOLD}Lade erweiterte Daten zu Google Sheets hoch...{RESET}", flush=True)
upload_csv_to_sheet("./docs/data/advanced_leaderboard.csv", "Advanced_Leaderboard")
print(f"{GREEN}Erweiterte Daten hochgeladen.{RESET}", flush=True)
upload_csv_to_sheet("./docs/data/elo_history.csv", "ELO_History")
print(f"{GREEN}ELO-Verlauf hochgeladen.{RESET}", flush=True)
upload_csv_to_sheet("./docs/data/elo_timeseries.csv", "ELO_Timeseries")
print(f"{GREEN}ELO-Zeitreihe hochgeladen.{RESET}", flush=True)
upload_csv_to_sheet("./docs/data/bey_counters.csv", "Bey_Counters")
...
for file in os.listdir("./docs/data/leaderboards/"):
    if file.startswith("leaderboard_") and file.endswith(".csv"):
        ...
        upload_csv_to_sheet(f"./docs/data/leaderboards/{file}", f"Single_Leaderboard_{t_idx}")
