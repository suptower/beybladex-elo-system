...
del _os, _root
from src.config.paths import ELO_HISTORY_CSV, ADVANCED_LEADERBOARD_DROP_ATTACK_CSV  # noqa: E402
...
ADVANCED_FILE = ADVANCED_LEADERBOARD_DROP_ATTACK_CSV
...
with open(HISTORY_FILE, newline="", encoding="utf-8") as f:
    ...
    for row in matches:
        # Only process Drop Attack arena matches for Drop Attack advanced statistics
